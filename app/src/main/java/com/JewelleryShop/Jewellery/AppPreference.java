...
public class AppPreference {
    ...
    private String dummyMobile = Common.currentUser.getPhone();
    private String dummyAmount =String.valueOf(Cart.mextraprice+Cart.total);
    private String dummyEmail = SendOtp.email;
    private String productInfo = "product_info";
    private String firstName = Common.currentUser.getName();
