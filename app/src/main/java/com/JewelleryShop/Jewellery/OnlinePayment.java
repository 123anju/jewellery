...
import static com.JewelleryShop.Jewellery.SendOtp.email;
public class OnlinePayment extends BaseActivity implements View.OnClickListener
{
    public static final String TAG = "OnlinePayment : ";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mobile_et.setText(Common.currentUser.getPhone());
...
//        }
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(OnlinePayment.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(OnlinePayment.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("OnlinePayment", "request code " + requestCode + " resultcode " + resultCode);
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data !=
            ...
            if (transactionResponse != null && transactionResponse.getPayuResponse() != null) {
                if (transactionResponse.getTransactionStatus().equals(TransactionResponse.TransactionStatus.SUCCESSFUL))
                {
                    ...
                    List<Order> cart = new CreateDB(this).getCarts();
                    Request request = new Request(
                            Common.currentUser.getPhone(),
                            Common.currentUser.getName(),
                            Cart.address,
                            Cart.price,
                            cart,date.toString(),"Online Payment"
                    );
                    // Submit to firebase
                    ...
                    db.cleanCart();
                    Cart.total = 0;
                    Toast.makeText(this, "Transaction Succcessful", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(OnlinePayment.this,MainActivity.class);
                    startActivity(i);
                }
                else
                {
                    //Failure Transaction
                    Toast.makeText(this, "Sorry! please try after some time", Toast.LENGTH_SHORT).show();
                    Intent i =new Intent(OnlinePayment.this,Home.class);
...
//                        }).show();
    ...
    private void launchPayUMoneyFlow() {
        ...
        AppEnvironment appEnvironment = ((BaseApplication) getApplication()).getAppEnvironment();
        builder.setAmount(Cart.total+Cart.conveni)
                .setTxnId(txnId)
                .setPhone(phone)
...
/*            *//**
           ...
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,OnlinePayment.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,OnlinePayment.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(OnlinePayment.this);
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(OnlinePayment.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
    ...
    private void sendTestEmail() {
        ...
        BackgroundMail.newBuilder(this)
                ...
                .withBody("<br><b>Customer  Name : </b>"
                        + Common.currentUser.getName()
                        +"<br><b>Customer Address :</b>"+  Cart.address +" "+Cart.location
                        +"<br><b>Mobile Number :</b>"+Common.currentUser.getPhone()
                        +"<br><b>Verified Email Id :</b>"+ email
                        +"<br><b>order has been placed</b><br><hr>" + s
                        +"<br><b>Price:</b>" + String.valueOf(Cart.total)+"<br><b>Convinience Charges:</b>" + String.valueOf(Cart.conveni)+"<br><b>Total Price:</b>" + Cart.total+Cart.conveni +"<br><b>Payment Mode: Online Payment</b><br><hr>" )
...
//do some magic
    ...
    private void sendTestEmail1() {
        ...
        BackgroundMail.newBuilder(this)
                ...
                .withType("text/html")
                .withSubject("Order is placed")
                .withBody("<br><b>Customer  Name : </b>"+ Common.currentUser.getName()+"<br><b>Customer Address :</b>"+  Cart.address +" "+Cart.location+"<br><b>Mobile Number :</b>"+Common.currentUser.getPhone()+"<br><b>order has been placed</b><br><hr>" + s+"<br><b>Price:</b>" + String.valueOf(Cart.total)+"<br><b>Convinience Charges:</b>" + String.valueOf(Cart.conveni)+"<br><b>Total Price:</b>" + Cart.total+Cart.conveni+"<br><b>Payment Mode: Online Payment</b><br><hr>" )
                .withOnSuccessCallback(new BackgroundMail.OnSuccessCallback() {
                    @Override
                    public void onSuccess() {
//do some magic
